...
Shipwright's C/C++ in `soh/` is formatted with **clang-format 20**, the version
...
The script calls `clang-format 20` by default. If your clang-format 20 is named
...
downloads clang-format 20.1.8 itself (needs [7-Zip](https://www.7-zip.org/)
